...
namespace ECommerceApp.Infrastructure.Migrations
{
    ...
    [Migration("20260311154130_AddProductVideoUrl")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.Survey", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyQuestion", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.Survey", b =>
                {
                    b.HasOne("ECommerceApp.Core.Entities.SurveyType", "SurveyType")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyAnswer", b =>
                {
                    b.HasOne("ECommerceApp.Core.Entities.SurveyResponse", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("ECommerceApp.Core.Entities.SurveyQuestion", b =>
                {
                    b.HasOne("ECommerceApp.Core.Entities.Survey", null)
                        .WithMany("Questions")
